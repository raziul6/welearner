<?php
     ...
     */
?>
<div class="trending-couse-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
            <div class="section-heading d-flex justify-content-between align-items-center">
                <h1><?php echo esc_html(get_theme_mod('welen_trending_heading', __("Trending", "welearner")));?></h1>
                <a href="<?php echo esc_url(get_theme_mod('welen_trending_btn_url',));?>"><?php echo esc_html(get_theme_mod('welen_trending_btn_text', __("Show All", "welearner")));?> </a>
            </div>
            </div>
        </div>
        <div class="row">
